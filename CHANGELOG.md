...
- CI linting with ruff (check + format) and ty (type checking) on all PRs
- Pre-commit config for local development
- Automated GitHub releases and PyPI publishing on version bump

### Fixed

- All existing lint issues (line length, ambiguous vars, unused f-strings)
